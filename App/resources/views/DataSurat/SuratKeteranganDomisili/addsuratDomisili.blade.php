    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb" class="mb-1">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('/surat-tidak-mampu')}}" class="text-decoration-none">Surat Keterangan Domisili</a></li>
                <li class="breadcrumb-item active" aria-current="page">Surat Keterangan Domisili Baru</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-header"><strong>Form</strong> Surat Keterangan Domisili</div>
                    <div class="card-body">
                        <form action="{{ url('/surat-domisili/add') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col">
                                    <table class="table table-borderless">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-outline">
                                                    <input value="{{old('tgl_surat_dibuat')}}" type="date" name="tgl_surat_dibuat" id="tgl_surat_dibuat" class="form-control @error('tgl_surat_dibuat') is-invalid @enderror" autocomplete="off"/>
                                ...
                                <div class="col">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-outline">
                                                    <input value="{{old('pekerjaan_pemohon')}}" type="text" name="pekerjaan_pemohon" id="pekerjaan_pemohon" class="form-control @error('pekerjaan_pemohon') is-invalid @enderror" autocomplete="off"/>
