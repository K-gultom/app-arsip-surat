    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb" class="mb-1">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Surat Keterangan Domisili Edit</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('/surat-domisili/edit') }}/{{ $getData->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <td>
                                                <div class="form-outline">
                                                    ...
                                                    <select value="{{ old('kewarganegaraan') ?? '' }}" name="kewarganegaraan" class="form-control @error('kewarganegaraan') is-invalid @enderror" id="">
                                                        <option value=""></option>
                                                        <option value="WNI" {{ old('kewarganegaraan', $getData->kewarganegaraan) == 'WNI' ? 'selected' : '' }}>WNI</option>
                                                        <option value="WNA" {{ old('kewarganegaraan', $getData->kewarganegaraan) == 'WNA' ? 'selected' : '' }}>WNA</option>
                                                    </select>
                                                    <span class="input-group-text"><i class="bi bi-caret-down-fill"></i></span>
                                                    </div>
