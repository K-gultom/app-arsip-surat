...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <center>
                <h3><u>SURAT KETERANGAN USAHA</u></h3>Nomor: {{ $getData->nomor_surat }}
            </center>
        </div>

        <div class="awal tab" style="text-align: justify">
            <p>Bersama ini Kepala Desa Karya Mukti Kecamatan Mesuji Kabupaten Ogan Komering Ilir, menerangkan sebagai berikut:</p>
        </div>
        ...
        <div class="ketiga tab" style="text-align: justify">
            <p>
                Bahwa Nama tersebut diatas benar Warga Desa Karya Mukti Kecamatan Mesuji Kabupaten Ogan Komering Ilir, dan nama tersebut diatas benar mempunyai usaha dibidang:
            </p>
        </div>
        ...
        <div class="kelima tab" style="text-align: justify">
            <p>
                Demikian Surat Keterangan Usaha ini dibuat dengan sebenarnya, agar dapat dipergunakan sebagai mana mestinya.
            </p>
        </div>

        <div class="tanda_tangan">
            <p>
                <span>Karya Mukti, {{ $tanggal_Surat }}</span><br>
                <span>{{  $getData->getUser->Jabatan }}</span>
            </p>
        </div>
