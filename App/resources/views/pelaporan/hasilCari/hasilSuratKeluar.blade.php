    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex">
                    ...
                    <div class="w-100 pt-1 text-end">
                        <a href="{{ url('/pelaporan/surat-keluar') }}" class="btn btn-primary btn-sm">Kembali <i class="bi bi-arrow-clockwise"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row pb-4">
                    <div class="col">
                        <form action="{{ url('/cetak/surat-keluar') }}" method="post" target="_blank">
                            @csrf
                ...
                <div class="row">
                    <div class="col">
                        <h5>Hasil Pencarian Surat Keluar</h5>
